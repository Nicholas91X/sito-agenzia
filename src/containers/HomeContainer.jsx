...
export default function HomeContainer() {
    ...
    // Hook personalizzato per gestire autoplay/pausa durante lo scroll
    ...
    // Array di servizi da mostrare tramite .map
    const services = [
    ...
    // Funzione per scrollare verso il basso al click
    ...
    return (
        <>
            ...
            {/* Sezione Hero: video in background, overlay, titolo e scroll indicator */}
            <section>
                <VideoHero
                    videoRef={mainVideoRef}
                    videoSrc="/assets/videos/hero_video_wide.mp4"
                    titleText="Welcome Into Digital Era"
                    onScrollDown={handleScrollDown}
                />
            </section>

            {/* Sezione Contenuti: "Cosa facciamo" */}
            <section>
                <UnderVideoSection
                    sx={{
                        padding: {
                            xs: '0 1rem 2.5rem 1rem',
                            sm: '0 3rem',
                            md: '0 10rem',
                            lg: '0 5rem 5rem 5rem',
                            xl: '0 10rem',
                ...
                >
                    <BoxUnderVideoSection
                        sx={{ padding: { xs: '2rem 0', sm: '0', lg: '0 5rem', xl: '0 5rem' } }}
                    >
                    ...
                    <BoxUnderVideoSection
                        sx={{
                            margin: {
                                xs: '2.5rem 0 1.25rem 0',
                                sm: '2.5rem 0 1.25rem 0',
                                lg: '5rem 0 2.5rem 0',
                            },
                        }}
                    >
